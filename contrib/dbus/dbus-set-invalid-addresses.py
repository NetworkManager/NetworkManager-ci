...
def assert_invalid_addresses(family: str, addrs):
...
assert_invalid_addresses("ipv4", [dbus.Array([1, 2], signature="u")])

# ipv4: invalid prefix
assert_invalid_addresses("ipv4", [dbus.Array([0, 33, 0], signature="u")])

# ipv6: invalid length address
assert_invalid_addresses("ipv6", [(invalid_ipv6, dbus.UInt32(64), valid_ipv6)])

# ipv6: invalid length gateway
assert_invalid_addresses("ipv6", [(valid_ipv6, dbus.UInt32(64), invalid_ipv6)])

# ipv6: invalid prefix
assert_invalid_addresses("ipv6", [(valid_ipv6, dbus.UInt32(129), valid_ipv6)])

# error is returned also when there are other valid addresses
assert_invalid_addresses(
    "ipv4",
    [dbus.Array([0, 24, 0], signature="u"), dbus.Array([0, 33, 0], signature="u")],
)
assert_invalid_addresses(
    "ipv6",
    [
        (valid_ipv6, dbus.UInt32(64), valid_ipv6),
        (valid_ipv6, dbus.UInt32(129), valid_ipv6),
    ],
)
