...
network_setup() {
  ...
  nmcli con add autoconnect "no" type "bridge" bridge.stp "no" ethernet.cloned-mac-address "random" con-name "bond0_0"  ifname "bond0_0"  slave-type "bond" master "bond0"
  nmcli con add autoconnect "no" type "bridge" bridge.stp "no" ethernet.cloned-mac-address "random" con-name "bond0_1"  ifname "bond0_1"  slave-type "bond" master "bond0"
  nmcli con add autoconnect "no" type "bridge" bridge.stp "no" ethernet.cloned-mac-address "random" con-name "bond1_0"  ifname "bond1_0"  slave-type "bond" master "bond1"
  nmcli con add autoconnect "no" type "bridge" bridge.stp "no" ethernet.cloned-mac-address "random" con-name "bond1_1"  ifname "bond1_1"  slave-type "bond" master "bond1"
