Feature: nmcli: tuntap
    ...
    * Add a new connection of type "tun" and options "ifname tap0 con-name tap0 tun.mode 1 ipv4.addresses 1.2.3.4/24 ipv4.method manual"
    When "tap0:connected:tap0" is visible with command "nmcli -t -f DEVICE,STATE,CONNECTION device" in "10" seconds
    Then Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 owner"
     And Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 group"
     And Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 mode tun"
     And Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 multi-queue"
     And Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 vnet-hdr"
     And Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 nopi"
    ...
    * Bring "up" connection "tap0"
    Then Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 owner 1000"
     And Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 group 1002"
     And Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 mode tap"
     And Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 multi-queue false"
     And Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 vnet-hdr true"
     And Execute "bash tmp/tuntap_device_kernel_properties.sh tap0 nopi false"
