 Feature: nmcli: sriov
    ...
    * Commentary
        ...
        """
    * Execute "nmcli connection modify sriov_controller sriov.preserve-on-down yes sriov.total-vfs 3"
    * Bring "up" connection "sriov_controller"
    ...
    * Execute "nmcli connection modify sriov_controller sriov.preserve-on-down default sriov.total-vfs 4"
    * Bring "up" connection "sriov_controller"
    ...
    * Commentary
        ...
        """
    * Execute "nmcli connection modify sriov_controller sriov.preserve-on-down no sriov.total-vfs 2"
    * Bring "up" connection "sriov_controller"
    Then "2" is visible with command "cat /sys/class/net/sriov_device/device/sriov_numvfs"
    ...
    * Commentary
        ...
        """
    * Execute "nmcli connection modify sriov_controller sriov.preserve-on-down no sriov.total-vfs 3"
    * Bring "up" connection "sriov_controller"
    Then "3" is visible with command "cat /sys/class/net/sriov_device/device/sriov_numvfs"
    * Bring "down" connection "sriov_controller"
    Then "0" is visible with command "cat /sys/class/net/sriov_device/device/sriov_numvfs"
