Feature: nmcli: ipv4
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method manual ipv4.addresses 192.168.122.253"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method static ipv4.addresses 192.168.122.253"
    Then "192.168.122.253/32" is visible with command "ip a s eth3"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method static ipv4.addresses 192.168.122.253/24"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method static ipv4.addresses 192.168.122.253/24 ipv4.gateway 192.168.122.96"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method static ipv4.addresses '192.168.22.253/24, 192.168.122.253/16, 192.168.222.253/8' ipv4.gateway 192.168.22.96"
     ...
     * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 autoconnect no ipv4.may-fail no"
     * Add a new connection of type "ethernet" named "con_ipv42" and options "ifname eth3 autoconnect no ipv4.may-fail no"
     * Bring "up" connection "con_ipv4"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method static ipv4.addresses '192.168.22.253/24, 192.168.122.253/16' ipv4.gateway 192.168.22.96"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ipv4.method static ipv4.addresses 192.168.1.10/24 ipv4.gateway 192.168.4.1 ipv4.routes '192.168.2.0/24 192.168.1.11 2' ipv4.route-metric 22"
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method static ipv4.addresses 192.168.3.10/24 ipv4.gateway 192.168.4.1 ipv4.routes '192.168.5.0/24 192.168.3.11 1' ipv4.route-metric 21"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method manual ipv4.addresses 192.168.3.10/24 ipv4.gateway 192.168.4.1 ipv4.route-metric 256 ipv4.routes '192.168.5.0/24 192.168.3.11 1024 cwnd=14 lock-mtu=true mtu=1600'"
    ...
    @ipv4_route_set_route_with_options
    Scenario: nmcli - ipv4 - routes - set route with options
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method manual ipv4.addresses 192.168.3.10/24 ipv4.gateway 192.168.4.1 ipv4.route-metric 256 ipv4.routes '192.168.5.0/24 192.168.3.11 1024 cwnd=14 lock-mtu=true mtu=1600, 0.0.0.0/0 192.168.4.1 mtu=1600'"
    Then "default via 192.168.4.1 dev eth3\s+proto static\s+metric 256" is visible with command "ip route" in "20" seconds
    Then "192.168.3.0/24 dev eth3\s+proto kernel\s+scope link\s+src 192.168.3.10\s+metric 256" is visible with command "ip route"
    Then "192.168.4.1 dev eth3\s+proto static\s+scope link\s+metric 256" is visible with command "ip route"
    Then "192.168.5.0/24 via 192.168.3.11 dev eth3\s+proto static\s+metric 1024\s+mtu lock 1600 cwnd 14" is visible with command "ip route"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method manual ipv4.addresses 192.168.3.10/24 ipv4.gateway 192.168.4.1 ipv4.route-metric 256 ipv4.routes '192.168.122.3 src=192.168.3.10'"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method manual ipv4.addresses 192.168.3.10/24 ipv4.gateway 192.168.4.1 ipv4.route-metric 256"
    * Execute "echo '192.168.122.3 src 192.168.3.10 dev eth3' > /etc/sysconfig/network-scripts/route-con_ipv4"
    * Reload connections
    * Bring "up" connection "con_ipv4"
    * Stop NM
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method static ipv4.addresses 192.168.3.10/24 ipv4.gateway 192.168.4.1 ipv4.routes '192.168.5.0/24 192.168.3.11'"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.may-fail no ipv4.route-table 300"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.may-fail no"
    When "connected" is visible with command "nmcli -g state,device device |grep eth3$" in "20" seconds
    # This is cripppled in kernel VVV 1535977
    # Then "default" is visible with command "ip r show table 300"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method manual ipv4.address '192.0.2.1/24,192.0.2.2/24' ipv6.method manual ipv6.addresses '1:2:3:4:5::1/64,1:2:3:4:5::2/64'"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.may-fail no ipv4.method static ipv4.addresses 192.168.3.10/24 ipv4.gateway 192.168.4.1 ipv4.routes '192.168.5.0/24 192.168.3.11 2'"
    * Add a new connection of type "ethernet" named "con_ipv42" and options "ifname eth2 ipv4.may-fail no ipv4.method static ipv4.addresses 192.168.1.10/24 ipv4.gateway 192.168.4.1 ipv4.routes '192.168.2.0/24 192.168.1.11 3'"
    ...
    * Bring "up" connection "con_ipv42"
    ...
    @ipv4_route_remove_basic_route
    Scenario: nmcli - ipv4 - routes - remove basic route
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.may-fail no ipv4.method static ipv4.addresses 192.168.3.10/24 ipv4.gateway 192.168.4.1 ipv4.routes '192.168.5.0/24 192.168.3.11 200'"
    * Add a new connection of type "ethernet" named "con_ipv42" and options "ifname eth2 ipv4.may-fail no ipv4.method static ipv4.addresses 192.168.1.10/24 ipv4.gateway 192.168.4.1 ipv4.routes '192.168.2.0/24 192.168.1.11 300'"
    * Modify connection "con_ipv4" changing options "ipv4.routes ''"
    * Modify connection "con_ipv4" changing options "ipv4.routes ''"
    * Bring "up" connection "con_ipv4"
    * Bring "up" connection "con_ipv42"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ip4 192.168.122.123/24 ipv4.routes '10.20.30.10/24 192.168.122.2'"
    Then "^connected" is visible with command "nmcli -t -f STATE,DEVICE device |grep eth3" in "5" seconds
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method static ipv4.addresses 192.168.122.2/24 ipv4.gateway 192.168.122.1 ipv4.routes 192.168.1.0/24"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method static ipv4.addresses 192.168.122.2/24 ipv4.gateway 192.168.122.1 ipv4.routes '192.168.1.0/24 192.168.3.11 1'"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method static ipv4.addresses 192.168.122.253/24 ipv4.gateway 192.168.122.1 ipv4.dns '8.8.8.8, 8.8.4.4'"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.ignore-auto-dns yes ipv6.ignore-auto-dns yes"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.dns 8.8.8.8"
    * Bring "up" connection "con_ipv4"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method static ipv4.addresses 192.168.122.253/24 ipv4.gateway 192.168.122.1 ipv4.dns '8.8.8.8'"
    * Bring "up" connection "con_ipv4"
    * Open editor for connection "con_ipv4"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.addresses 192.168.122.253/24 ipv4.gateway 192.168.122.1 ipv4.dns '8.8.8.8, 8.8.4.4'"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth0  ipv4.may-fail no ipv4.dns '8.8.8.8, 8.8.4.4'"
    * Bring "up" connection "con_ipv4"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth0  ipv4.may-fail no ipv4.dns-search google.com"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ipv4.may-fail no ipv4.dhcp-fqdn foo.bar.com"
    * Run child "sudo tshark -l -O bootp -i eth2 > /tmp/tshark.log"
    When "empty" is not visible with command "file /tmp/tshark.log" in "150" seconds
    * Bring "up" connection "con_ipv4"
    ...
    * Bring "up" connection "con_ipv4"
    ...
    @nmcli_ipv4_override_fqdn
    Scenario: nmcli - ipv4 - dhcp-fqdn - override dhcp-fqdn
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ipv4.may-fail no ipv4.dhcp-fqdn foo.bar.com ipv4.dhcp-hostname-flags fqdn-clear-flags"
    * Bring "up" connection "con_ipv4"
    * Run child "sudo tshark -l -O bootp -i eth2 > /tmp/tshark.log"
    When "empty" is not visible with command "file /tmp/tshark.log" in "150" seconds
    * Bring "up" connection "con_ipv4"
    ...
    Scenario: nmcli - ipv4 - dhcp-fqdn - override dhcp-fqdn
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ipv4.may-fail no ipv4.dhcp-fqdn foo.bar.com ipv4.dhcp-hostname-flags 'fqdn-serv-update fqdn-encoded'"
    * Bring "up" connection "con_ipv4"
    * Run child "sudo tshark -l -O bootp -i eth2 > /tmp/tshark.log"
    When "empty" is not visible with command "file /tmp/tshark.log" in "150" seconds
    * Bring "up" connection "con_ipv4"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname testX4 ipv4.dhcp-fqdn foo.bar.com ipv4.may-fail no"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ipv4.may-fail no"
    * Run child "sudo tshark -l -O bootp -i eth2 > /tmp/tshark.log"
    When "empty" is not visible with command "file /tmp/tshark.log" in "150" seconds
    * Bring "up" connection "con_ipv4"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.dns-options debug ipv4.may-fail no"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 autoconnect no ipv4.dns-options debug ipv4.may-fail no"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv6.method ignore ipv6.ignore-auto-dns yes ipv4.dns-search google.com ipv4.ignore-auto-dns yes"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method link-local ipv6.method ignore"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ipv4.may-fail no ipv4.dhcp-client-id AB"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ipv4.may-fail no ipv4.dhcp-client-id abcd"
    * Run child "sudo tcpdump -i eth2 -v -n > /tmp/tcpdump.log"
    When "empty" is not visible with command "file /tmp/tcpdump.log" in "150" seconds
    * Bring "up" connection "con_ipv4"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ipv4.may-fail no ipv4.dhcp-client-id BC"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ipv4.may-fail no autoconnect no"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 autoconnect no ipv4.dhcp-client-id 1 ipv4.may-fail yes ipv6.method manual ipv6.addresses ::1"
    Then Bring "up" connection "con_ipv4"


    @ipv4_method_disabled
    Scenario: nmcli - ipv4 - method - disabled
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 autoconnect no ipv4.method disabled ipv6.method manual ipv6.addresses ::1"
    Then Bring "up" connection "con_ipv4"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 autoconnect no ipv4.may-fail no ipv4.never-default yes "
    * Bring "up" connection "con_ipv4"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.may-fail no ipv4.method manual ipv4.addresses 1.2.3.4/24 ipv4.gateway 1.2.3.1 ipv4.never-default yes"
    * Restart NM
    ...
    * Add a new interface of type "veth" named "test1" and options "peer name test1p"
    * Add a new interface of type "veth" named "test2" and options "peer name test2p"
    * Add a new interface of type "bridge" named "vethbr"
    ...
    * Add a new connection of type "ethernet" named "tc1" and options "ifname test1 ip4 192.168.99.1/24"
    * Add a new connection of type "ethernet" named "tc2" and options "ifname test2"
    ...
    * Prepare simulated test "testX4" device
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname testX4 ipv4.may-fail no"
    ...
    * Prepare simulated test "testX4" device
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname testX4 ipv4.dhcp-timeout 60 autoconnect no"
    * Execute "ip netns exec testX4_ns kill -SIGSTOP $(cat /tmp/testX4_ns.pid)"
    ...
    * Prepare simulated test "testX4" device
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname testX4 ipv4.dhcp-timeout infinity autoconnect no"
    * Execute "ip netns exec testX4_ns kill -SIGSTOP $(cat /tmp/testX4_ns.pid)"
    ...
    * Prepare simulated test "testX4" device
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname testX4 autoconnect no"
    * Execute "ip netns exec testX4_ns kill -SIGSTOP $(cat /tmp/testX4_ns.pid)"
    * Execute "sleep 50; ip netns exec testX4_ns kill -SIGCONT $(cat /tmp/testX4_ns.pid)" without waiting for process to finish
    * Restart NM
    * Bring "up" connection "con_ipv4"
    ...
    * Prepare simulated test "testX4" device
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname testX4 "
    ...
    * Add a new connection of type "ethernet" named "connie" and options "ifname testY4"
    ...
    * Add a new connection of type "ethernet" named "con_ipv42" and options "ifname testA4 ipv4.may-fail no"
    ...
    * Add a new connection of type "ethernet" named "profie" and options "ifname testZ4 ipv4.may-fail no"
    * Bring "up" connection "con_ipv42"
    ...
    * Prepare simulated test "testX4" device
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname testX4 ipv4.may-fail no autoconnect no"
    * Bring "up" connection "con_ipv4"
    ...
    * Execute "nmcli device reapply testX4"
     ...
     * Prepare simulated test "testX4" device
     * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname testX4 ipv4.may-fail no ipv4.method manual ipv4.addresses 192.168.99.1/24"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 autoconnect no"
    ...
    * Add a new connection of type "ethernet" named "tc1" and options "autoconnect no ifname test1 ipv4.method shared ipv6.method ignore"
    * Add a new connection of type "ethernet" named "tc2" and options "autoconnect no ifname test2"
    ...
    * Add a new connection of type "ethernet" named "tc1" and options "autoconnect no ifname test1 ipv4.method shared ipv6.method ignore"
    * Add a new connection of type "ethernet" named "tc2" and options "autoconnect no ifname test2 ipv4.may-fail yes ipv6.method manual ipv6.addresses 1::1/128"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ipv4.method manual ipv4.addresses '192.168.1.5/24,192.168.1.4/24,192.168.1.3/24'"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ipv4.method manual ipv4.addresses '192.168.1.3/24,192.168.1.4/24,192.168.1.5/24'"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth2 ip4 192.168.11.1/24"
    * Add a new connection of type "ethernet" named "con_ipv42" and options "ifname eth3 ip4 192.168.11.2/24"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method manual ipv4.addresses 192.168.3.10/24 ipv4.gateway 192.168.3.254"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ip4 192.168.124.1/24 ip4 192.168.125.1/24"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.dhcp-hostname test"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname testX4 ipv6.method manual ipv6.addresses dead::beaf/128"
    When "activated" is visible with command "nmcli -g GENERAL.STATE con show con_ipv4" in "45" seconds
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method manual ipv4.addresses 192.168.3.10/24"
    ...
    * Prepare simulated test "testX4" device
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname testX4 autoconnect no ipv4.method auto ipv4.addresses 192.168.3.10/24 ipv4.routes '192.168.5.0/24 192.168.3.11 101'"
    * Execute "ip netns exec testX4_ns kill -SIGSTOP $(cat /tmp/testX4_ns.pid)"
    ...
    * Add a new connection of type "ethernet" named "con_general" and options "ifname testS autoconnect no ethernet.cloned-mac-address 00:11:22:33:44:55 ipv6.method disabled ipv4.address 192.168.13.37/24"
    ...
    * Prepare veth pairs "test1,test2" bridged over "vethbr"
    * Add a new connection of type "ethernet" named "tc1" and options "ifname test1 ip4 172.21.1.1/24 ipv6.method ignore"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method manual ipv4.addresses 172.16.0.2/31"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.dhcp-client-id duid"
    ...
    * Add a new connection of type "bridge" named "br88" and options "ifname br88 bridge.stp false ipv4.dhcp-client-id duid"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.dhcp-client-id duid ipv4.dhcp-iaid ifname"
    When "inet" is visible with command "ip a s eth3 | grep -E -o 'inet\s+[0-9.]*'" in "40" seconds
    * Note the output of "ip a s eth3 | grep -E -o 'inet\s+[0-9.]*'" as value "ipv4_eth3"
    * Add a new connection of type "bridge" named "br88" and options "ifname br88 bridge.stp false ipv4.dhcp-client-id duid ipv4.dhcp-iaid ifname"
    * Modify connection "con_ipv4" changing options "connection.master br88 connection.slave-type bridge"
    * Bring "up" connection "br88"
    * Bring "up" connection "con_ipv4"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.dhcp-client-id duid ipv4.dhcp-iaid mac"
    When "inet" is visible with command "ip a s eth3 | grep -E -o 'inet\s+[0-9.]*'" in "10" seconds
    * Note the output of "ip a s eth3 | grep -E -o 'inet\s+[0-9.]*'" as value "ipv4_eth3"
    * Add a new connection of type "bridge" named "br88" and options "ifname br88 bridge.stp false ipv4.dhcp-client-id duid ipv4.dhcp-iaid mac"
    * Modify connection "con_ipv4" changing options "connection.master br88 connection.slave-type bridge"
    * Bring "up" connection "br88"
    * Bring "up" connection "con_ipv4"
    When "inet" is visible with command "ip a s br88 | grep -E -o 'inet\s+[0-9.]*'" in "10" seconds
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.method manual ipv4.addresses 192.168.47.1/24"
    ...
    * Add a new connection of type "ethernet" named "con_ipv4" and options "ifname eth3 ipv4.dhcp-vendor-class-identifier RedHat"
