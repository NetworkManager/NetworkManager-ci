Feature: nmcli: cloud
    ...
    * Add "ethernet" connection named "conX1" for device "eth11" with options "autoconnect no ipv4.method manual ipv4.address 192.168.101.11/24"
    * Bring "up" connection "conX1"
    * Mock Aliyun metadata for device with MAC address "eth11"
    * Mock Aliyun CIDR block "172.31.16.0/20" for device with MAC address "eth11"
    * Mock Aliyun IP addresses "172.31.176.249" and "172.31.17.249" with mask "255.255.240.0" for device with MAC address "eth11"
    * Mock Aliyun Gateway "172.31.176.1" for device with MAC address "eth11"
    * Check "ipv4" address list "192.168.101.11/24" on device "eth11"
    * Execute nm-cloud-setup for "aliyun" with mapped interfaces "eth11=<noted:eth11>"
    Then Check "ipv4" address list "192.168.101.11/24 172.31.176.249/20 172.31.17.249/20" on device "eth11" in "2" seconds
    * Mock Aliyun IP addresses "172.31.186.249" and "172.31.18.249" with mask "255.255.240.0" for device with MAC address "eth11"
    * Execute nm-cloud-setup for "aliyun" with mapped interfaces "eth11=<noted:eth11>"
    Then Check "ipv4" address list "192.168.101.11/24 172.31.186.249/20 172.31.18.249/20" on device "eth11" in "2" seconds
    ...
    * Add "ethernet" connection named "conX1" for device "eth11" with options "autoconnect no ipv4.method manual ipv4.address 192.168.101.11/24"
    * Bring "up" connection "conX1"
    * Execute "ip addr add 192.168.100.200/24 dev eth11"
    * Mock EC2 metadata for device with MAC address "eth11"
    * Mock EC2 CIDR block "172.31.16.0/20" for device with MAC address "eth11"
    * Mock EC2 IP addresses "172.31.176.249" and "172.31.17.249" for device with MAC address "eth11"
    * Check "ipv4" address list "192.168.101.11/24 192.168.100.200/24" on device "eth11"
    * Execute nm-cloud-setup for "ec2" with mapped interfaces "eth11=<noted:eth11>"
    Then Check "ipv4" address list "192.168.101.11/24 192.168.100.200/24 172.31.176.249/20 172.31.17.249/20" on device "eth11" in "2" seconds
    * Mock EC2 IP addresses "172.31.186.249" and "172.31.18.249" for device with MAC address "eth11"
    * Execute nm-cloud-setup for "ec2" with mapped interfaces "eth11=<noted:eth11>"
    Then Check "ipv4" address list "192.168.101.11/24 192.168.100.200/24 172.31.186.249/20 172.31.18.249/20" on device "eth11" in "2" seconds
