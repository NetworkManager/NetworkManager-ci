Feature: nmcli - vlan
    ...
    * Execute "ip add add 1::666/128 dev test1.100"
    * Execute "ip add add 1::777/128 dev test1"
    * Stop NM
    Then "inet 10.1.0" is visible with command "ip a s test1.100" for full "5" seconds
