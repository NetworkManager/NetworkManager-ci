...
## Basically various bug related reproducer tests follow here
    ...
    * Execute "cd nmstate && ulimit -n 10000 && pytest -vv tests/integration -k 'not nm_team_plugin_missing | disable_nm_team_plugin' --log-level=DEBUG 2>&1 | tee /tmp/nmstate.txt"
