Feature: NM: dracut
    ...
    * Run dracut test "contrib/dracut/TEST-20-NFS" named "NFSv3 Bridge Customized root=dhcp DHCP path,options"
    ...
    #* Run dracut test "contrib/dracut/TEST-20-NFS" named "NFSv3 root=dhcp DHCP proto:IP:path,options"
    * Run dracut test "contrib/dracut/TEST-20-NFS" named "@rhbz1627820 NFSv3 root=dhcp DHCP lease renewal bridge"
    * Run dracut test "contrib/dracut/TEST-20-NFS" named "@rhbz1710935 NFSv3 root=dhcp rd.neednet=1"
    * Run dracut test "contrib/dracut/TEST-20-NFS" named "@rhbz1854323 NFSv3 root=nfs:[ipv6]... ip=auto6"
    * Run dracut test "contrib/dracut/TEST-20-NFS" named "@rhbz1854323 NFSv3 root=nfs:[ipv6]... ip=dhcp6"
